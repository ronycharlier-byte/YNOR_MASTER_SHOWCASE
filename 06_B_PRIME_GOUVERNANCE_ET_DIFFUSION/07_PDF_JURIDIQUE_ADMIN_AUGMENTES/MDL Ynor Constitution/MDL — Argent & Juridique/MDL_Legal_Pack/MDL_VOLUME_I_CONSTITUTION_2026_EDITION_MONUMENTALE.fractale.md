...
```text
CORPUS MDL VOLUME I — CONSTITUTION FONDATRICE ÉDITION MONUMENTALE 2026 Date d’édition : 17 February 2026 Document Constitutionnel à portée normative, philosophique et structurante. PRÉAMBULE Le présent Volume constitue la fondation constitutionnelle du Corpus MDL. Il établit les principes invariants, la hiérarchie interne, la doctrine de cohérence structurelle et les règles d’interprétation. Ce texte est rédigé dans une perspective intemporelle et vise à encadrer toute application présente ou future du Corpus.
```
