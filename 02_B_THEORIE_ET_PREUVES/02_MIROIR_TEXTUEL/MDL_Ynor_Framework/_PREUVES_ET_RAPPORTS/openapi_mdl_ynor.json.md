# MIROIR TEXTUEL - openapi_mdl_ynor.json

Source : MDL_Ynor_Framework\_PREUVES_ET_RAPPORTS\openapi_mdl_ynor.json
Taille : 8704 octets
SHA256 : bd3e82b17ee44867af7803bc29ae4d06b4ce7f03e1c3bbfc51f14ddea26f034f
          ...
          "content": {
            "application/json": {
              "schema": {
                "type": "object",
                "properties": {
                  "alpha": { "type": "number", "description": "Coefficient d'énergie." },
                  "beta": { "type": "number", "description": "Coefficient de dissipation." },
                  "kappa": { "type": "number", "description": "Coefficient d'inertie." }
                },
                "required": ["alpha", "beta", "kappa"]
              }
            }
          }
        },
          ...
          "content": {
            "application/json": {
              "schema": {
                "type": "object",
                "properties": {
                  "alpha_q": { "type": "number", "description": "Coefficient quantique alpha (0.5 à 5.0)." },
                  "system_dims": { "type": "integer", "default": 2, "description": "Dimensions du système." }
                },
                "required": ["alpha_q"]
              }
            }
          ...
          "content": {
            "application/json": {
              "schema": {
                "type": "object",
                "properties": {
                  "intensity": { "type": "number", "description": "Intensité entre 0.0 et 1.0." }
                },
                "required": ["intensity"]
              }
            }
            ...
            "content": {
              "application/json": {
                "schema": {
                  ...
                  "properties": {
                    "status": { "type": "string" },
                    "decoherence_rate": { "type": "number" },
                    "mu_after_shock": { "type": "number" },
                    "warning": { "type": "string" }
                  }
                }
              }
            ...
            "application/json": {
              "schema": {
                ...
                "properties": {
                  ...
                  "kappa": { "type": "number" },
                  "alpha_q": { "type": "number" },
                  "system_dims": { "type": "integer", "default": 2 }
                },
                "required": ["alpha", "beta", "kappa", "alpha_q"]
              }
            }
          }
        },
            ...
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
                  "properties": {
                    "classic_audit": { "type": "object" },
                    "quantum_audit": { "type": "object" },
