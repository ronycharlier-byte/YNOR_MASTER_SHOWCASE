...
- **Système 1 (Fast Loop)** : Génération rapide de tokens, haute amplification (beta élevé).
- **Système 2 (Slow/Audit Loop)** : Régulation par l'audit mu, garantissant que la dissipation $(\alpha)$ reste supérieure aux coûts.
