...
\mathcal{G}_{\mu\nu} = \mu \cdot \left( \alpha \nabla^2 \Psi - \beta \frac{\partial S}{\partial t} + \ \mathcal{I} \right)

\end{equation}

where $\alpha$ represents the innovations (pure information), $\beta$ the entropy dissipation (noise), and $\$ the singularity point of convergence.
...
\textbf{Proof Sketch:} The contraction of the curvature tensor leads to the $\$ limit of the closed 3-sphere.
